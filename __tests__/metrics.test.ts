...
describe("MetricsTracker", () => {
  ...
  it("should record completion tokens", () => {
    const tracker = createMetricsTracker("qwen-turbo");
  ...
  it("should produce a human-readable summary", () => {
    ...
    expect(summary).toContain("qwen-max");
